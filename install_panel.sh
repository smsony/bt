...
panel_Url='https://github.com/smsony/bt1/releases/latest/download/install.zip'
bt_Url='https://raw.githubusercontent.com/smsony/bt/master'

cn=$(curl -fsSL -m 10 http://ipinfo.io/json | grep "\"country\": \"CN\"")
if [[ "$cn" != "" ]];then
	panel_Url='https://ghproxy.com/github.com/smsony/bt1/releases/latest/download/install.zip'
	bt_Url='https://fastly.jsdelivr.net/gh/smsony/bt@latest'
fi

if [ "$1" == "dev" ];then
	panel_Url='https://ghproxy.com/github.com/smsony/bt1/releases/download/beta/install.zip'
fi
